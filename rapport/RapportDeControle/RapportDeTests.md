...
| ----- | --------------------------------------------------- | ------------------ | ------------------------------------------------------------ | :--------: | --------- |
| Oui   | Etablissement de la communication                   | Professeur / élève | Envoi au serveur ``/online ....``                            |            |           |
| Oui   | Identification initiale auprès du serveur           | Professeur / élève | Envoi au serveur   ``/getRights <sidUser>``                  |            |           |
| Oui   | Termine la communication                            | Professeur / élève | Envoie au serveur ``/offline <sidComputer>``      puis ``/bye`` |            |           |
| Oui   | Envoi d'un screenshot                               | élève              | Envoi au serveur ``/sendScreen ...``                         |            |           |
| Oui   | Demande les sceenshots au serveur                   | Professeur         | Envoi au serveur ``/getScreens <sidGrp>``                    |            |           |
| Oui   | Demande les groupes d'élèves connectés au serveur   | Professeur         | Envoi au serveur ``/getGroups``                              |            |           |
| Oui   | Demande les informations pour un groupe renseigné   | Professeur         | Envoi au serveur ``/getGroupInfo <sidGrp>``                  |            |           |
|       | Demande de bloquer les inputs d'un élève            | Professeur         | Envoi au serveur ``/lock <sid>``                             |            |           |
|       | Demande de bloquer les inputs de plusieurs élèves   | Professeur         | Envoi au serveur ``/lock <sid>``                             |            |           |
|       | Demande de débloquer les inputs d'un élève          | Professeur         | Envoi au serveur ``/unlock <sid>``                           |            |           |
