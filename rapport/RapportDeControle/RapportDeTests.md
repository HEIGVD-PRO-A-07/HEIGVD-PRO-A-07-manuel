...
|  Oui  | Gestion du timeout d'un poste                                |                                                              |     LT      | 26.05.20  |
...
|  Oui  | Termine la communication                             | élève              | Envoi au serveur ``/offline <sidComputer>``   puis ``/exit`` |            |           |
|  Oui  | Termine la communication lors de la fermeture du GUI | Professeur         | Envoi au serveur ``/exit``                                   |            |           |
